...
## Algorithm
1. Preprocess the emails (clean text, remove stopwords, convert to lowercase).
2. Convert text to numerical features using TF-IDF.
3. Train the model using Support Vector Machine classifier.
4. Predict and evaluate spam or ham using accuracy/confusion matrix. 
